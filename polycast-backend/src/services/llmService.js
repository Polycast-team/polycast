 ...
 */
async function translateTextBatch(text, targetLanguages, sourceLanguage = 'English') {
    initializeLLM();
    if (!text || text.trim().length === 0) {
