...
export const UI_STRINGS = {
  ...
  'German': {
    ...
    dictionaryMode: 'Wörterbuch', flashcardMode: 'Karten',
  ...
  'Italian': {
    ...
    dictionaryMode: 'Dizionario', flashcardMode: 'Carte',
  ...
  'Portuguese': {
    ...
    dictionaryMode: 'Dicionário', flashcardMode: 'Cartões',
